    ...
    (s.prototype = new e()),
      ...
      (s.prototype.getImages = function () {
        ...
        for (var t = 0, e = this.elements.length; e > t; t++) {
          ...
          for (
            var n = i.querySelectorAll("img"), o = 0, r = n.length;
            r > o;
            o++
          ) {
            var s = n[o];
      ...
      (s.prototype.check = function () {
        function t(t, o) {
          return (
            e.options.debug && p && c.log("confirm", t, o),
            e.progress(t),
            i++,
            i === n && e.complete(),
            !0
    ...
    function i(t) {
      ...
      function o(e, i) {
        t.fn[e] = function (o) {
          if ("string" == typeof o) {
            for (
              var s = n.call(arguments, 1), a = 0, u = this.length;
              u > a;
              a++
            ) {
              var h = this[a],
    ...
    function n(t) {
      function n(t) {
        if (
          ...
          for (
            var c = (o.isBorderBox = !(!h || !n[h] || "border-box" !== n[h])),
              p = 0,
              d = s.length;
            d > p;
            p++
          ...
          var y = o.paddingLeft + o.paddingRight,
            ...
            S = c && u,
            L = e(n.width);
          L !== !1 && (o.width = L + (S ? 0 : y + E));
          var x = e(n.height);
          return (
            x !== !1 && (o.height = x + (S ? 0 : g + w)),
          ...
          for (
            ...
            if (d(s))
              if (e) {
                f(s, e) && i.push(s);
                for (
                  var a = s.querySelectorAll(e), u = 0, h = a.length;
                  h > u;
                  u++
                )
                  i.push(a[u]);
  ...
  (function (t) {
    ...
    docReady(function () {
      ...
      (i.getSomeItemElements = function () {
        for (
          var t = document.createDocumentFragment(), e = [], i = 0;
          3 > i;
          i++
        ) {
          var n = document.createElement("div"),
            o = Math.random(),
            r = o > 0.85 ? "w4" : o > 0.7 ? "w2" : "",
            s = Math.random(),
            a = s > 0.85 ? "h4" : s > 0.7 ? "h2" : "";
    ...
    (i.notify = function (t, r) {
      ...
      (i.hideNotify = function () {
        a
          ? ((n.style[a] = "opacity 1.0s"), (n.style.opacity = "0"))
      ...
      (function () {
        ...
        (function () {
          var t = document.querySelector(
              "#animate-item-size-responsive .masonry"
            ),
            e = new Masonry(t, {
  ...
  (function (t) {
    ...
    function e() {
      var t = document.createElement("div"),
        e = Math.random(),
        i = Math.random(),
        n = e > 0.92 ? "w4" : e > 0.8 ? "w3" : e > 0.6 ? "w2" : "",
        o = i > 0.85 ? "h4" : i > 0.6 ? "h3" : i > 0.35 ? "h2" : "";
    ...
    i.methods = function () {
      (function () {
        var t = document.querySelector("#appended-demo"),
          ...
          o = new Masonry(i, { columnWidth: 60 });
        eventie.bind(n, "click", function () {
          for (
            var t = [], n = document.createDocumentFragment(), r = 0;
            3 > r;
            r++
          ) {
            var s = e();
        ...
        (function () {
          var t = document.querySelector("#destroy-demo"),
            ...
            n = new Masonry(e, { columnWidth: 60 }),
            o = !0;
