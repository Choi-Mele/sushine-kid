  subSliderArr = [// window.subSlider = []  === subSlider = [] // 전역변수, 모든위치에서 사용하는 변수
    {
      path:'01.jpg',
      title :'회사소개',
